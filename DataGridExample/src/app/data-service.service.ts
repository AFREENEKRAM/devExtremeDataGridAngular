...
export class DataServiceService {
  ...
  getCompanies() {
    ...
    /* Here You can Call your BackEnd Service For the Data Source*/

    /*-------------------------- LIKE THIS---------------------------
    getDetail(): Observable<any> {
    return this.httpclient.get(http://localhost:8088/myGrid, {
      headers: _headers
    });
  }
  */
 /*yOU CAN USE ANGULAR-REDUX-STORE for adding Store mechanism in your application
  OR 
  you can simply subscribe to the Response of this call
*/
